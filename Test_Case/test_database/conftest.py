...
# =====================================================================================
@pytest.fixture(scope="class", autouse=True)  # 🔥 autouse=True se marker ka jhanjhat khatam!
def db_session(request):
    ...
    try:
        ...
        connection = psycopg2.connect(
            ...
            sslmode='require'  # Neon Cloud ke liye yeh zaroori hai
        )
        ...
        #FINALLY BLOCK: Test pass ho ya fail, connection har haal mein safely close hoga!
